...
b.    What is the image of the imaginary axis $\dsp L_{2}=\left\{\mi y |y \in 
\mathbb{R}\right\}$ under $f$?\\
c.    What is the image of the vertical line $L_{3}=\left\{-\frac{\pi}{2}+\mi y\bigg| 
y\in\mathbb{R}\right\}$ under $f$?\\
d.    What is the image of the vertical line $\dsp L_{4}=\left\{\frac{\pi}{2}+\mi y \bigg| 
y\in\mathbb{R}\right\}$ under $f$?\\
...
c. Again for $\dsp x = -\frac{\pi}{2}$ we get $\dsp 
...
Recall: $\textrm{Log}(z)$ denotes the \textit{principal branch} of logarithm, that is, 
$\textrm{Log}(z)=\ln⁡|z|+\mi \textrm{Arg}(z)$, 
...
\right\}$ (this is yet another part of the boundary of $A$) as well as the image of this 
...
\mathfrak{Re}(z) = 0\right\}$ (this is the fourth part of the boundary of $A$) as well 
